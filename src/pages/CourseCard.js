...
<Card style={{background:'black', border: 'rgb(185, 27, 100) 2px solid',borderRadius: '55px',borderColor:'linear-gradient(to right, #0000ff 0%, #ff00ff 100%)'}}>
      <Card.Body style={{backgroundColor:'black', borderColor:'purple'}}>
        {/* YouTube video embed */}
        <iframe style={{backgroundColor: 'rgb(185, 27, 100)'}}
          width="100%"
          height="350"
